...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 * height matching. This function will have no effect when 'none' or '30px' row height
	 * matching is used.
	...
	{
		nTarget.style.height = 30+iHeight+"px";
	},
		...
		var nSWrapper =
			$('<div class="DTFC_ScrollWrapper" style="position:relative; clear:both;">'+
				'<div class="DTFC_LeftWrapper" style="position:absolute; top:0; left:0;">'+
					...
					'<div class="DTFC_LeftBodyWrapper" style="position:relative;  top:0; left:0; overflow:hidden; border-right:1px solid #ddd;">'+
				...
				'<div class="DTFC_RightWrapper" style="position:absolute; top:0; left:0;">'+
					...
					'</div>'+
					'<div class="DTFC_RightBodyWrapper" style="position:relative; top:0; left:0; overflow:hidden; border-left:1px solid #ddd;">'+
						'<div class="DTFC_RightBodyLiner" style="position:relative; top:0; left:0; overflow-y:scroll; overflow-x:scroll;"></div>'+
						// '<div class="DTFC_RightBodyLiner" style="position:relative; top:0; left:0;"></div>'+
					'</div>'+
	...
	"_fnGridLayout": function ()
	{
		...
		oGrid.wrapper.style.height = 30+iFullHeight+"px";

		if ( this.s.iLeftColumns > 0 )
		{
			iLeftWidth = iLeftWidth-3;
			oGrid.left.wrapper.style.width = iLeftWidth+"px";
			oGrid.left.wrapper.style.height = "30px";
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		 ...
		 * Body
		 */
		if ( this.s.sHeightMatch == '30px' )
		{
			/* Remove any heights which have been applied already and let the browser figure it out */
			$('>tbody>tr', that.dom.body).css('height', '30px');
		}

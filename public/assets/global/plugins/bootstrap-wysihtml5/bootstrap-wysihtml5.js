!function($, wysi) {
    ...
    var tpl = {
        ...
        "font-size": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn default dropdown-toggle" + size + "' data-toggle='dropdown' href='#'>" +
              "<i class='icon-font'></i>&nbsp;<span class='current-fontA'>Font Size</span>&nbsp;<b class='caret'></b>" +
              "</a>" +
              "<ul class='dropdown-menu'>" +
                "<li><a data-wysihtml5-command='fontSize' data-wysihtml5-command-value='extra-small'>" + locale.font_size.extra_small + "</a></li>" +
                "<li><a data-wysihtml5-command='fontSize' data-wysihtml5-command-value='small'>" + locale.font_size.small + "</a></li>" +
                "<li><a data-wysihtml5-command='fontSize' data-wysihtml5-command-value='normal'>" + locale.font_size.normal + "</a></li>" +
                "<li><a data-wysihtml5-command='fontSize' data-wysihtml5-command-value='large'>" + locale.font_size.large + "</a></li>" +
                "<li><a data-wysihtml5-command='fontSize' data-wysihtml5-command-value='extra-large'>" + locale.font_size.extra_large + "</a></li>" +
              "</ul>" +
            "</li>";
        },
    ...
    Wysihtml5.prototype = {
        ...
        createToolbar: function(el, options) {
            ...
            toolbar.find("a[data-wysihtml5-command='fontSize']").click(function(e) {
                var target = e.target || e.srcElement;
                var el = $(target);
                self.toolbar.find('.current-fontA').text(el.html());
            });
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        parserRules: {
            classes: {
                ...
                "wysiwyg-font-size-extra-small": 1,
                "wysiwyg-font-size-small": 1,
                "wysiwyg-font-size-normal": 1,
                "wysiwyg-font-size-large": 1,
                "wysiwyg-font-size-extra-large": 1
            },
            tags: {
                "b":  {},
                "i":  {},
        ...
        stylesheets: [base_url+'public/assets/global/plugins/bootstrap-wysihtml5/wysiwyg-color.css'], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };

var Table_nppa_workscope = function () {
    ...
    var handleTable = function () {
        ...
        function editRow(oTable, nRow) {
            var aData = oTable.fnGetData(nRow);
            var jqTds = $('>td', nRow);
            jqTds[0].innerHTML = '<input type="text" class="form-control input-small" >';
            ...
            jqTds[4].innerHTML = '<input type="text" class="form-control input-small" >';
            jqTds[5].innerHTML = '<input type="text" class="form-control input-small" >';
            jqTds[6].innerHTML = '<input type="text" class="form-control input-small" >';
        ...
        var table = $('#table_nppa_workscope');
        ...
        var tableWrapper = $("#table_nppa_workscope_wrapper");
        ...
        $('#table_nppa_workscope_new').click(function (e) {
            e.preventDefault();

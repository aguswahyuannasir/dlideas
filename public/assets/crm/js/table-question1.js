var TableAjax = function () {
    return {
        ...
        initDefault: function (url, header, order, sort) {
            ...
            grid.init({
                ...
                dataTable: {
                    ...
                    "fnStateSaveParams": function (oSettings, oData) {
                        ...
                        // if(exist == null){
                        //     $('.datatable select[name="custom_status"]').selectpicker('val', 'all');
                        // }
            ...
            // Trigger filter jika klick enter pada input search
            grid.getTableWrapper().on('keyup', '.datatable .form-filter', function (e) {
                if(e.keyCode == 13){
                    $('.datatable .filter-submit').first().click();
                }
            });
            ...
            grid.getTableWrapper().on('click', '.table-group-action-submit', function (e) {
                ...
                if (action.val() != "" && grid.getSelectedRowsCount() > 0) {
                    ...
                    if(action.val() == '0'){
                        message = 'Are you sure will Disable Data ?';
                        message_success = 'Your data Successfully disabled.';
                    }else if(action.val() == '1'){
                        message = 'Are you sure you want to Enable Data ?';
                        message_success = 'Your data has been activated successfully.';
                    }else if(action.val() == '99'){
                        message = 'Are you sure you want to Delete Data?';
                        message_success = 'Your data was deleted successfully.';
                    }else if(action.val() == '98'){
                        message = 'Are you sure you want to Manage Data Permanently?';
                        message_success = 'Your data was permanently deleted.';
                    }

	...
	<section class="gray">
        <div class="container">
            <div class="row feature-items justify-content-center">
                ...
                <?php //var_dump($arr_role);die(); ?>
		        <?php $i=0; foreach ($arr_role as $key=>$val) {?>
		        <a href="<?=site_url('login/change_session_role_id');?>/<?=$arr_role_id[$i];?>" data-wow-delay=".5s" class="col-md-3 col-sm-6 feature-item wow animated bounceIn feature-item-title btn_role_name" >

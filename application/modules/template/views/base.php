...
<!--<![endif]-->
    ...
    <head>
        ...
        <!-- Tmbahan CSS Custome-->
        <!-- <link href="<?php //echo base_url('public/assets/crm/css/custom.css');?>" rel="stylesheet" type="text/css"/>  -->
        <link href="<?php echo base_url('public/assets/crm/css/title_tip.css');?>" rel="stylesheet" type="text/css"/> 
...
<!-- BEGIN BODY -->
<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo" style="background-color:#e9ecf3;">
<!--    <div class="se-pre-con"></div>-->
      ...
      <!--   <div style="float:right; position:fixed; z-index:999999; right:10px; bottom:10px; background:black; padding:5px;">
        ...
        <script type="text/javascript">
            ...
            //btn read more
            $('.btn_more').die().live('click',function(){
